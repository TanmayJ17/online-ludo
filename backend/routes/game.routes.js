...
const { createRoom, joinRoom, selectColor, startGame, rollDice, moveToken, getGameState, createRoomVsBot } = require('../controllers/game.controller');
...
router.post('/create-vs-bot', requireAuth, createRoomVsBot);
